...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u"../../../Proyectos/Pentachoron/Abrir.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbrir.setIcon(icon1)
        self.actionGuardar = QAction(MainWindow)
        self.actionGuardar.setObjectName(u"actionGuardar")
        icon2 = QIcon()
        icon2.addFile(u"../../../Proyectos/Pentachoron/Guardar.png", QSize(), QIcon.Normal, QIcon.Off)
